function HeartSvgHovered({ width, height }: SvgProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width={width} height={height} fill="#3ED598">
...
export default HeartSvgHovered;
