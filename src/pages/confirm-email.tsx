...
function ConfirmEmail() {
  ...
  return (
    <main className="w-full h-screen flex flex-col justify-start items-center pt-16 overflow-x-hidden">
      <AnimatePresence>
        {activationStatus && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ ease: 'easeOut', duration: 0.2 }} className="flex flex-col justify-center items-center">
            <h2 className="px-3 pb-3 text-2xl text-center text-white xs:text-3xl">Your account got activated successfully!</h2>
