...
function Home() {
    return (
        <main
            className="to-darker-sea w-full h-full min-h-screen flex flex-col justify-start items-center overflow-x-hidden bg-gradient-to-b from-dark-seaweed lg:flex-row lg:justify-center">
