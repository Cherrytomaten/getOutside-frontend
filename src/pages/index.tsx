      ...
      <div className="relative max-w-full pt-6 -ml-24 lg:flex-1 lg:max-w-[410px] lg:ml:0">
        ...
        <div className="z-10 relative w-full h-60 flex flex-col justify-center items-center -mt-24">
          ...
          <motion.img
            initial={{ y: -50, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ ease: 'easeOut', duration: 0.3, delay: 0.5, opacity: { duration: 0.15 } }}
            className="w-auto h-full ml-56 drop-shadow-lg"
            src="assets/skate-stock.png"
        ...
        <div className="z-20 w-full h-60 flex flex-col justify-center items-center">
          ...
          <motion.img
            initial={{ y: -50, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ ease: 'easeOut', duration: 0.3, delay: 0.75, opacity: { duration: 0.15 } }}
            className="w-auto h-full -mt-28 mr-5 drop-shadow-lg"
            src="assets/boulder-stock.png"
      ...
      <div className="flex flex-col justify-center items-center lg:flex-1 lg:max-w-md lg:items-start lg:ml-32">
        <div className="px-2 -mt-6 text-center lg:mt-0">
          <motion.h2
            initial={{ y: 50, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ ease: 'easeOut', duration: 0.3, delay: 1.4, opacity: { duration: 0.15 } }}
            className="mb-5 text-5xl text-white xs:text-6xl">
            GetOutside
          </motion.h2>
          <motion.h3
            initial={{ y: 50, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ ease: 'easeOut', duration: 0.3, delay: 1.55, opacity: { duration: 0.15 } }}
            className="text-2xl font-light text-bright-seaweed xs:text-3xl">
            The app for outside
            <br />
            adventures!
          </motion.h3>
        </div>
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ ease: 'easeOut', duration: 0.4, delay: 1.7 }} className="w-full max-w-xs px-4 pb-24 mt-10 text-center">
          <Link href="/signup">
